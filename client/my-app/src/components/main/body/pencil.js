...
function Pencil({ changeColorEdit, defaultColorEdit }) {
  ...
  return (
    ...
    >
      ...
      >
        <path
          d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 
